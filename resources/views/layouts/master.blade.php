...
<head>
    ...
    <script src="{{ asset('publicc/keditor5-build-classic/ckeditor.js') }}"></script>
...
<div class="container">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            <a class="navbar-brand" href="{{route('index')}}"><i class="material-icons">home</i></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="{{ route('blog')}}">Page</a>
                    </li>
                    ...
                    @can('admin')
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="{{ route('listuser')}}">Quản lý người dùng</a>
                    </li>
                    @endcan
                </ul>
                <form class="d-flex">
